    ...
    for (const r of regions) {
        ...
        try {
            ...
            await client.query(`
                ...
                -- Update RLS for public.providers
                ...
                -- Update system_roles for TESORERO in app_settings
                DO $$
                DECLARE
                    roles_json jsonb;
                    updated_roles jsonb;
            ...
            return NextResponse.json({
                success: true,
                message: "Profiles and Providers RLS policies updated successfully for TESORERO and staff.",
                host: activeHost,
                policies: res.rows
            });
        } catch (err: any) {
