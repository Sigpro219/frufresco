                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', flex: 1 }}>
                                        {/* Special Alerts for TODO Column */}
                                            ...
                                            <div style={{ 
                                                ...
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                        <span style={{ fontSize: '0.85rem', color: '#0C4A6E' }}>Pendientes:</span>
                                        ...
                                        {col.id === 'todo' && incompleteCount > 0 && (
                                            <div style={{ 
                                                ...
                                                <p style={{ margin: '0 0 1rem 0', fontSize: '0.85rem', color: '#7C2D12', lineHeight: '1.4' }}>
                                                    Se han detectado <strong>{incompleteCount}</strong> proveedores sin datos completos.
                                                </p>
