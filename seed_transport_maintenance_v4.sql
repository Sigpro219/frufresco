...
-- FIX AND SEED MAINTENANCE DATA (V4 - FINAL FIX)
...
BEGIN
    ...
    -- FIX: Cast calculation to INTEGER for date arithmetic
    ...
    SELECT 
        ...
        'date', 
        365, 
        CURRENT_DATE + (FLOOR(RANDOM() * 60) - 10)::INTEGER, -- Cast explicit to INTEGER
        false,
        'active'
    FROM fleet_vehicles
    ON CONFLICT DO NOTHING;
